...
//        'click .my_profile': 'action_my_profile',
    ...
    action_contract_draft_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','draft'],['flow','=','supplier']],
    ...
    action_contract_count_pending_dict_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_dict'],['flow','=','supplier']],
    ...
    action_contract_count_pending_appro_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_appro'],['flow','=','supplier']],
    ...
    action_contract_count_approval_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','approval'],['flow','=','supplier']],
    ...
    action_contract_count_pending_signed_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_signed'],['flow','=','supplier']],
    ...
    action_contract_count_open_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','open'],['flow','=','supplier']],
    ...
    action_contract_count_close_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','close'],['flow','=','supplier']],
    ...
    action_contract_count_cancelled_purchase: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','cancelled'],['flow','=','supplier']],
