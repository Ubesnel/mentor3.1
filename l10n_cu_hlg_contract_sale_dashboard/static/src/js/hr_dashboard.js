...
//        'click .my_profile': 'action_my_profile',
    ...
    action_contract_draft: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','draft'],['flow','=','customer']],
    ...
    action_contract_count_pending_dict: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_dict'],['flow','=','customer']],
    ...
    action_contract_count_pending_appro: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_appro'],['flow','=','customer']],
    ...
    action_contract_count_approval: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','approval'],['flow','=','customer']],
    ...
    action_contract_count_pending_signed: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','pending_signed'],['flow','=','customer']],
    ...
    action_contract_count_open: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','open'],['flow','=','customer']],
    ...
    action_contract_count_close: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','close'],['flow','=','customer']],
    ...
    action_contract_count_cancelled: function(event){
        ...
        this.do_action({
            ...
            views: [[false, 'list'],[false, 'form']],
            target: 'current',
            domain:[['state','=','cancelled'],['flow','=','customer']],
